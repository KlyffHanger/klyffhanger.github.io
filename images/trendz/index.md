    ...
    <div class="main-bg">
        <main class="accent-circle">
            <div class="content">
                ...
                <p class="text">Connect Trendz to the Klyff in few clicks with automatic Topology Discovery.</p>
                <p class="text">Trendz works with all Klyff products, including: Open Source Klyff Community EditionKlyff Professional Edition.</p>
        ...
        <main>
            <div class="content">
                ...
                <div class="text">
                    ...
                    <ul>
                        <li>Adding them on Klyff dashboards</li>
                        <li>Embedding on 3rd party web sites</li>
                        <li>Exporting data into spreadsheets and images</li>
                    </ul>
                </div>
                <p class="text">All with respect to Klyff user permissions.</p>
