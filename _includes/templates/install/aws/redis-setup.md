You'll need to set up [Amazon ElastiCache (Redis)](https://aws.amazon.com/elasticache/redis/). Klyff uses cache to improve performance and avoid frequent DB reads.
