...
def collect_required_data():
    config = {}
    print("\n\n", "="*80, sep="")
    print(" "*10, "\033[1m\033[94mKlyff device provisioning with access token authorization example script. HTTP API\033[0m", sep="")
    print("="*80, "\n\n", sep="")
    host = input("Please write your Klyff \033[93murl\033[0m or leave it blank to use default ({{httpsUrl}}): ")
    config["host"] = host if host else "{{httpsUrl}}"
    port = input("Please write your Klyff \033[93mHTTP port\033[0m or leave it blank to use default (443): ")
