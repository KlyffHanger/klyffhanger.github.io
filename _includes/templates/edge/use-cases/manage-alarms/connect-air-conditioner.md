...
- Replace **YOUR_TB_EDGE_HOST** with your Klyff Edge host. For example, **localhost**.

- Replace **YOUR_TB_EDGE_MQTT_PORT** with your Klyff Edge MQTT port. For example, **11883** or **1883**.
