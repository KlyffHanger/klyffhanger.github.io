...
An Edge Rule Chain Template is a predefined Rule Chain in Klyff, designed specifically for use with Klyff Edge. 
...
{% assign createRuleChainTemplatePE = '
    ===
        ...
        title: Sign in to your <b>Klyff PE</b> instance and navigate to the "Edge Management" -> "Rule chain templates" page. Click the "+" icon in the top right corner and choose "Create new rule chain".
    ===
...
{% assign createRuleChainTemplateCE = '
    ===
        ...
        title: Sign in to your <b>Klyff CE</b> instance and navigate to the "Edge Management" -> "Rule chain templates" page. Click the "+" icon in the top right corner and choose "Create new rule chain".
    ===
...
#### Assigning the Rule Chain Template to Klyff Edge
...
{% assign verifyRuleChainPE = '
    ===
        ...
        title: Sign in to your <b>Klyff Edge PE</b> instance and navigate to the "Rule chains" page. Click on the rule chain that was recently assigned to open and view it.
    ===
...
{% assign verifyRuleChainCE = '
    ===
        ...
        title: Sign in to your <b>Klyff Edge CE</b> instance and navigate to the "Rule chains" page. Click on the rule chain that was recently assigned to open and view it.
    ===
