...
Where:    
- `restart: always` - automatically start Klyff Edge in case of system reboot and restart in case of failure;
...
- `CLOUD_RPC_HOST` - ip address of the machine with the Klyff platform;
{% if docsPrefix == 'pe/edge/' %}
