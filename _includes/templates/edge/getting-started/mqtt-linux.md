...
For example, $HOST_NAME reference your local Klyff Edge installation, MQTT port is **1883** and access token is **ABC123**:
...
**Note:** Since Klyff 3.2, you are able to use basic MQTT credentials (combination of client id, user name and password ) 
