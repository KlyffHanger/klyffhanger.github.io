...
<section id="talkToUs">
    <div id="gettingHelp">
        ...
        <a href="https://stackoverflow.com/questions/tagged/thingsboard">
            ...
            <p>The Klyff team actively monitors posts that are tagged with "thingsboard" on the user forum. If you can't find an existing question that addresses your issue, feel free to ask a new one. Our team will be happy to assist you.</p>
        </a>
    </div>
</section>

If you are unable to find a solution to your problem from any of the guides provided above, please do not hesitate to contact the Klyff team for further assistance.
