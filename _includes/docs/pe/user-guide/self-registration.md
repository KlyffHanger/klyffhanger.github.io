...
### Step 1. Install Klyff in the cloud 

We will need a running Klyff PE instance with white-labeling feature enabled. 
You can easily deploy your own Klyff PE instance using the [installation instructions](/docs/user-guide/install/pe/installation-options/). 
Note that your instance should run in the cloud, and have public IP address assigned to it.

### Step 2. Assign DNS record to your Klyff IP address
...
### Step 3. Setup HTTPS access to your Klyff instance
...
They are available for Linux distributions and Docker. You can easily issue a valid Let's Encrypt certificate and setup HTTPS for your Klyff instance.
...
Configure Klyff using your SMTP server settings. If you don't have one, the easiest way is to use [SendGrid](https://sendgrid.com/).
