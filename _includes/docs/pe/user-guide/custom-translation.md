...
The Custom translation feature allows you to add new languages not currently supported by Klyff, edit the existing locale translations, and gives opportunity to customize specific dashboard GUI elements.
...
To change the Klyff's interface language, follow these steps:
...
After completing these steps, Klyff's interface language will be changed to the language of your choice.
...
This is where Klyff's internationalization feature comes into play.
