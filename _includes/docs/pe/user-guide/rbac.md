...
## Klyff CE vs PE security features comparison

#### Klyff Community Edition

![image](/images/user-guide/security/rbac/TB_CE.png)

Klyff Community Edition supports a straight-forward security model with three main roles: *System administrator*, *Tenant administrator*, and *Customer user*. 
...
Klyff Community Edition functionality is sufficient for a lot of simple use cases, especially building real-time [end-user dashboards](/docs/{{docsPrefix}}user-guide/dashboards/).

#### Klyff Professional Edition

![image](/images/user-guide/security/rbac/TB_PE.png)

Klyff Professional Edition brings much more flexibility in terms of user, customer, and role management. 
...
Klyff supports the "recursive" customer hierarchy with tens of thousands of sub-customers.
...
The Klyff Professional Edition security model support advanced RBAC for IoT applications and includes security features such as:
...
This document covers features that are exclusive to Klyff Professional Edition. We will start with a glossary and will provide step-by-step examples of how to configure the most popular use cases.
...
Users are able to login to the Klyff web interface, execute REST API calls, access devices, and assets if it's allowed. The User is also an Entity in Klyff.
...
An Entity can be a device, asset, user, dashboard, entity view, etc. Any entity is managed by Klyff. See [entities and relations](/docs/{{docsPrefix}}user-guide/entities-and-relations/) guide for more details.
...
If the Customer owner is another Customer, it means that this is a sub-customer. There might be multiple levels of Customers in Klyff.

**Resource**

Anything that has the secure APIs or represents a Klyff Entity is a resource. 
...
In Klyff Professional Edition, there are two types of roles: [Generic](/docs/{{docsPrefix}}user-guide/rbac/#generic-roles) and [Group](/docs/{{docsPrefix}}user-guide/rbac/#group-roles). Each role type has its own permissions.
...
Klyff use special “connection” called Group Permission Entity (GPE) which grants permissions of Generic Role for User Group.
...
| API Usage State               | "All", "Read", "Read Telemetry"                                                                                                                                                                                                                                                                    | API Usage layout is in the main menu of the Klyff platform. API Usage shows full statistics on the platform. Learn more about API Usage [here](/docs/{{docsPrefix}}user-guide/ui/aliases/#api-usage-state).                                                                                                                                                                                                                                                                                                                                           |
...
| Edge                          | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | Klyff Edge is an extension of the Klyff platform designed for local data processing and device management in a distributed IoT environment. Klyff Edge supports offline operation when there is no access to the cloud-based Klyff server. Find out more information about Edge [here](/docs/edge/getting-started-guides/what-is-edge/).                                                                                                                                                                                            |
...
| Integration                   | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | Integration is the process of connecting and interacting Klyff with other systems or devices to exchange and manage data. To know more about the Integrations check the article [here](/docs/{{docsPrefix}}user-guide/integrations/).                                                                                                                                                                                                                                                                                                                 |
...
| Profile                       | “All”, “Read”, “Write”, “Create”, “Delete”                                                                                                                                                                                                                                                         | With these permissions, the user can edit their profile information and change the login password for their Klyff instance.                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Role                          | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Roles in Klyff define a set of permissions and access rights assigned to users to perform specific actions in the system. Roles allow limiting or granting access to functionality and data based on the user’s role.                                                                                                                                                                                                                                                                                                                                 |
| Rule Chain                    | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Rule Chain in Klyff is a sequence of rules and actions applied to data received from devices or other sources. Rule Chains automate data processing, enable decision-making based on specific conditions, and perform actions such as notifications, device state changes, and other operations. Rule Chains can be configured to process and route data for various purposes, simplifying the development and deployment of IoT logic in the Klyff system. Learn more about rule chain [here](/docs/{{docsPrefix}}user-guide/ui/rule-chains/). |
...
| Version Control               | “All”, “Delete”, “Read”, “Write”                                                                                                                                                                                                                                                                   | Klyff Version Control service provides the ability to export and restore Klyff Entities using Git. Learn more about Version Control [here](/docs/{{docsPrefix}}user-guide/version-control/).                                                                                                                                                                                                                                                                                                                                                    |
...
To summarize those requirements in Klyff terms, we should implement the following roles:
...
Let's configure Klyff to support this use case. The instructions below assume that you have logged in as a Tenant Administrator.
