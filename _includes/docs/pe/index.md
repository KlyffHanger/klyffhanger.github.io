...
<p>The Klyff Professional Edition(PE) documentation can help you set up Klyff PE, learn about the platform and get your IoT projects running on Klyff PE.</p>
{% elsif docsPrefix contains 'paas/' %}
{% assign peDocsPrefix = docsPrefix %}
{% assign platformName = 'Klyff Cloud' %}
...
<p>The Klyff Cloud documentation can help you to start with Klyff Cloud, learn about the platform and get your IoT projects running on Klyff Cloud.</p>
{% endif %}
