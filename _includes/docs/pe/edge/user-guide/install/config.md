...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>localhost</td>
			<td> Hostname or IP of the Klyff platform, e.g. thingsboard.cloud, demo.thingsboard.io, X.X.X.X or localhost</td>
		</tr>
		<tr>
			<td>cloud.rpc.port</td>
			<td>CLOUD_RPC_PORT</td>
			<td>7070</td>
			<td> Port for RPC communication with the Klyff server</td>
		</tr>
		<tr>
...
<table>
	...
	<tbody>
		...
		<tr>
			<td>swagger.title</td>
			<td>SWAGGER_TITLE</td>
			<td>Klyff REST API</td>
			<td> The title on the API doc UI page</td>
		</tr>
		<tr>
			<td>swagger.description</td>
			<td>SWAGGER_DESCRIPTION</td>
			<td> Klyff Professional Edition IoT platform REST API documentation.</td>
		...
		<tr>
			...
			<td> Instance data is auto-generated and is used to identify particular Klyff Edge Instance.
