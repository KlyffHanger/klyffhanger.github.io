...
The Klyff Python REST API Client helps you interact with Klyff REST API from your Python script.
With Python Rest Client you can programmatically create assets, devices, customers, users and other entities and their relations in Klyff.

Source code of the Python REST API Client you can find [here](https://github.com/thingsboard/python_tb_rest_client).

In order to install the Klyff Python REST client, you should use the following command:
...
This feature is available in Klyff 3.4+. 
We have designed script, based on tb-rest-client library to make example how to use ability to configure Klyff from your code.  
...
In this example we configure [version control feature](/docs/user-guide/version-control) on Klyff.  
...
|-|-|  
| -H | **Klyff host (Default: localhost)**                                                            |    
| -p | **Klyff port (Default: 80)**                                                                   |  
| -U | **Klyff user (email for login)**                                                               |  
| -P | **Klyff user password**                                                                        |
