...
Don't forget to replace **YOUR_TB_HOST** with the host of your Klyff instance and **YOUR_ACCESS_TOKEN** with the access token of your device.
...
Now you may use the *ca-root.pem* to setup secure connection to your Klyff instance (*YOUR_TB_HOST*) and Access Token (*YOUR_ACCESS_TOKEN*) to authenticate the device to upload telemetry:
