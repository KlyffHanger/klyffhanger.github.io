...
There are three levels of roles on the Klyff platform. It is possible to create a user on each level.
...
**NOTE:**
<br>
To receive an email from Klyff, you should set up a mail server at the system administrator level in advance.
