...
To try this functionality, use the [Klyff Cloud](https://{{hostName}}/signup) server.
The alternative option is to install Klyff locally using this [installation guide](/docs/user-guide/install/pe/installation-options/)
{% endcapture %}
