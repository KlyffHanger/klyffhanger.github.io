...
This guide will help you to get familiar with Klyff configuration files and parameters. We **recommend** to
configure Klyff using environment variables. This way you do not need to merge the configuration files when new
...
If Klyff is installed on **Linux** as a **monolithic application**, you may specify the environment variables in
...
If Klyff is installed on **Windows** as a **monolithic application**, you may specify the environment variables in
...
If Klyff is installed in a docker compose environment, you may edit the scripts and add environment variables for
...
If Klyff is installed in a K8S environment, you may edit the scripts and add environment variables for the
