To install Klyff Arduino SDK - we will need to do the following steps:  
...
{% assign libraryInstallation = '
    ...
    ===
        ...
        title: Put "**Klyff**" into the search box and press "***INSTALL***" button for the found library.
' 
%}
...
All provided code examples require Klyff Library version {% if wifininaInstallationRequired == "true" %}**0.10.2**{% else %}**0.14.0**{% endif %}.  
