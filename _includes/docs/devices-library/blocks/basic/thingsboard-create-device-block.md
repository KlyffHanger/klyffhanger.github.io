...
{% assign provisionDeviceCE = '
    ===
        ...
        title: Login to your Klyff instance and navigate to the "**Entities**". Then click the "**Devices**" page.
    ===
...
{% assign provisionDevicePE = '
    ===
        ...
        title: Log in to your Klyff instance and open the Devices page.
    ===
