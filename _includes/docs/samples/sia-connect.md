...
In this comprehensive guide, we will walk you through the process of connecting an OPC-UA device to the Klyff platform via SIA Connect. 

The [SIA Connect](https://sia-connect.com/){:target="_blank"} is a tool that enables this process. 
By connecting your OPC-UA device to the Klyff platform, you can monitor, control, and automate your devices in a highly scalable and flexible way. Stay tuned as we guide you step by step through this process.

{% capture difference %}
Before proceeding with this guide, it's recommended that you follow [Getting Started](/docs/{{docsPrefix}}getting-started-guides/helloworld/){:target="_blank"} guide to become familiar with Klyff devices and dashboards. This will enhance your learning experience and understanding of the concepts presented here.
{% endcapture %}
{% include templates/info-banner.md content=difference %}

## Creating device on Klyff
...
Also, we need to download <b>MQTT</b> connector to establish connection with Klyff. The steps are as for downloading MQTT connector:
...
- One for Klyff - this instance will map data from the device instance, convert it to a suitable format, and send data to Klyff.
...
#### Adding Klyff instance

This instance will map data from the device instance, convert it to a suitable format, and send data to Klyff. To add a new instance, use follow these steps:

- Go to the <b>"Instance"</b> tab in the side menu and click <b>"+ Add new instance"</b> button;
- Fill in the input fields:
  - "<b>Name</b>" - "<b>Klyff</b>";
  - "<b>Address</b>" - "<b>your Klyff host</b>". In our case - <b>thingsboard.cloud</b>;
  - <b>"Port"</b> - "<b>1883</b>";
...
- Click on the <b>"+ New mapping"</b> in the "<b>Mappings on Klyff</b>" section;
- For "<b>Sender Item</b>" select "<b>OPC-UA Device</b>" as instance and "<b>Temperature</b>" as "<b>Item</b>"; 
- For "<b>Receiver item</b>" select "<b>Klyff</b>" as "<b>Instance</b>" and "<b>Publish data</b>" as "<b>Item</b>"; 
...
Once you have successfully done all the steps above and SIA Connect has sent data, you can view it in the "Latest telemetry" tab of the device in your Klyff instance:

- Navigate to the "<b>Devices</b>" page of the "<b>Entities</b>" section of your <b>Klyff</b> instance;
...
For this purpose we need to create one more item in <b>Klyff</b> instance of the <b>SIA Connect</b>, like the following:

- Go to the "<b>Instance</b>" tab in the side menu and select "<b>Klyff</b>";
- Click on the "<b>+ New item</b>" in the "<b>Items</b>" section;
- Fill in the input fields:
...
The next step is to create another mapping for data transmission between the Klyff instance and the OPC-UA Device. For this purpose, follow the steps below:

- On the <b>Klyff</b> instance, scroll down to "<b>Mappings</b>" section and click on "<b>+ New Mapping</b>" button;
- For "<b>Sender Item</b>" select "<b>Klyff</b>" as instance and "<b>Shared attribute update</b>" as "<b>Item</b>"; 
...
Finally, we need to create shared attribute on the device on Klyff platform. For this purpose, follow these steps:

- Go to the "<b>Devices</b>" page of the "<b>Entities</b>" section of your <b>Klyff</b> instance;
...
By following the instructions provided in this guide, you'll be able to effortlessly establish a connection between your OPC-UA device and the Klyff platform using SIA Connect. 
