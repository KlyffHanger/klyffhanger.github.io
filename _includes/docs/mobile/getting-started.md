...
{% assign cloudApp = "[Klyff Cloud](https://thingsboard.cloud/signup)" %}
...
<table>
    <thead>
        <tr>
          <td style="width: 50%"><b>Klyff version</b></td><td style="width: 50%"><b>Flutter Klyff Mobile Application</b></td><td style="width: 50%"><b>Dart Klyff Client</b></td>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<table>
    <thead>
        <tr>
          <td style="width: 50%"><b>Klyff PE version</b></td><td style="width: 50%"><b>Flutter Klyff PE Mobile Application</b></td><td style="width: 50%"><b>Dart Klyff PE Client</b></td>
        </tr>
    </thead>
    <tbody>
        <tr>
...
Set value of **klyffApiEndpoint** constant to match api endpoint of your {{appPrefix}} server instance.<br>
In case of {{cloudApp}} set it to `{{cloudEndpoint}}`.

```dart
abstract class ThingsboardAppConstants {
  static const klyffApiEndpoint = '{{cloudEndpoint}}';
...
Our system leverages Firebase to send notifications from Klyff instance directly to mobile application.
...
Next, we will walk through step-by-step how to create a Firebase project, and within it, we will generate a private key. This key is required for securely connecting your Klyff instance to Firebase services. 

{% capture difference %}
**Please note:**
for Klyff CE, only the system administrator can configure mobile settings. For Klyff PE - the tenant can use the system administrator's configuration or specify their own.
{% endcapture %}
...
{% assign firebaseProjectCE = '
    ...
    ===
        ...
        title: Confirm the generation of your private key by clicking on the "Generate key" button. Keep this key safe, as you&#39;ll need it for the Klyff server-side operations;
    ===
        image: /images/mobile/pe/firebase-new-project-10-ce.png,
        title: Sign in to Klyff as a system administrator, open the "Settings" page and navigate to the "Notifications" tab. In the "Mobile settings" section, upload the private key file you generated in the Firebase project and click "Save" to finalize the configuration.
'
%}
...
{% assign firebaseProjectPE = '
    ...
    ===
        ...
        title: Sign in to your Klyff instance and open the "Settings" page. Navigate to the "Notifications" tab, and uncheck the "Use system mobile settings" box (if you log in as a tenant) in the "Mobile settings" section. Here, upload the private key file you generated in the Firebase project and click "Save" to finalize the configuration.
'
%}
...
- If your Klyff mobile application is intended for iOS:

```text
ios/Runner/GoogleService-Info.plist
```

- If your Klyff mobile application is intended for Android:
...
If you need to build and release Klyff Mobile Application for iOS or Android, please refer to [this guide](/docs/{{docsPrefix}}mobile/release/).

{% if docsPrefix != 'pe/' %}
## Live demo app

To be familiar with common app features try out our Klyff Live mobile application available on Google Play and App Store.
