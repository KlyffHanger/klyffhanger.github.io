...
In this guide we will describe how to connect standard Klyff widgets located on the dashboard with Trendz View. 
You can do this using Klyff dashboard aliases and **Trendz View - with filter alias** from **Trendz widget Bundle**.

**Example**: we have 10 **Machine** devices in Klyff. We want to create a dashboard that will show all **Machine** devices 
...
On Klyff side we setup a dashboard and add 2 widgets. Detailed instruction how to do this is not part of this tutorial, 
