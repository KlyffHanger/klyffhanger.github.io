...
description: Klyff Trendz Analytics Release Notes
...
* Fix time synchronization between Klyff dashboard and Trendz view
...
* Add support of new Klyff widget bundle format (ThingBoard 3.6+)
...
* Add widget auto-refresh in rela-time on the Klyff dashboard
...
* Update widget bundle to Klyff v3.5
...
**Improvements:**
 * Add support of the latest Klyff API version
 ...
 * Support for native data export in Klyff dashboards
 ...
 * Update native library for Klyff 3.4+
 ...
 * Add view templates
 * Save computed metrics as telemetry in Klyff
 ...
 * Support interval time window from Klyff
 * Improve performance for large datasets
 * Update native library for Klyff 3.3+
 ...
 * Host Klyff widget library resources inside Trendz service
 ...
 * Add native widget bundle for Klyff
 ...
 * Support Klyff Filtering API
 * Add Calendar heatmap widget
 * Configure Filter visibility
 * Support of row-click events in Klyff dashboards
 ...
 * Widget Bundle: take time from Klyff dashboard 
 * Widget Bundle: support multi-value filters via Klyff aliases 
 ...
 * Klyff public user authentication
