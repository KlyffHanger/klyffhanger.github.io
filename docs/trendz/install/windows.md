...
assignees:
- ashvayka
title: Installing Klyff Trendz Analytics on Windows
description: Installing Klyff Trendz Analytics on Windows
...
```yml
license:
    secret: "${TRENDZ_LICENSE_SECRET:YOUR_LICENSE_SECRET_HERE}" # license secret obtained from Klyff License Portal (https://license.thingsboard.io)
```
