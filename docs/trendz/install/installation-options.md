...
assignees:
  - vparomskiy
title: Klyff Trendz Analytics installation options
description: Klyff Trendz Analytics installation instructions for various operation systems
notitle: "true"
---
       ...
       <div class="install-options-hero">
          <div class="container">
            <div class="install-options-hero-content">
                <h1>Klyff Trendz Analytics installation options</h1>
            </div>
