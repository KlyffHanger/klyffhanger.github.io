...
description: Socket API support for Klyff IoT Gateway
...
This guide will help you to get familiar with Socket Connector configuration for Klyff IoT Gateway. 
...
In order to request client-side or shared device attributes from Klyff server node, Gateway allows sending attribute
requests.
...
shared attributes from Klyff. See [user guide](/docs/user-guide/attributes/) for more details.
