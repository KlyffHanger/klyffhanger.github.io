...
description: REST API enpoints support for Klyff IoT Gateway
...
This guide will help you to get familiar with REST Connector configuration for Klyff IoT Gateway.  
...
3. **ADVANCED** the remote response that will return by Klyff.
   ...
   2. Configure RuleChain in Klyff:
