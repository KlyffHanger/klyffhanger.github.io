...
description: MQTT protocol support for Klyff IoT Gateway
redirect_from: 
...
The device will be created and displayed in Klyff based on the passed parameters.
{:refdef: style="text-align: center;"}
...
This section of the configuration outlines an array that includes all the supported requests for both the gateway and Klyff:
