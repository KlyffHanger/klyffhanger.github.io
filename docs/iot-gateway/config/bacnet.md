...
description: BACnet protocol support for Klyff IoT Gateway
...
| **Parameter**  | **Default value**                  | **Description**                                                                                     |
|:-|:-|-
| **deviceName** | **BACnet Device ${objectName}**    | Device name for Klyff. You can use **objectName** property to get name of object from device. |
| **deviceType** | **default**                        | Device type for Klyff.                                                                        |
...
Configuration in this unit sub-section provides settings for processing data from BACnet device as an attribute of the device on Klyff platform instance.

| **Parameter**  | **Default value**  | **Description**                                     |
|:-|:-|-
| **key**        | **temperature**    | Attribute key for Klyff platform instance.    |
...
Configuration in this unit sub-section provides settings for processing data from BACnet device as telemetry of the device on Klyff platform instance. 

| **Parameter**  | **Default value** | **Description**                                     |
|:-|:-|-
| **key**        | **state**         | Telemetry key for Klyff platform instance.    |
...
Configuration in this unit sub-section provides settings for processing data from shared attributes on Klyff platform instance to the BACnet device.

| **Parameter**  | **Default value**  | **Description**                                                   |
|:-|:-|-
| **key**        | **brightness**     | Name of the shared attribute on Klyff instance.             |
...
Configuration in this unit sub-section provides settings for processing RPC from Klyff instance to the BACnet device.

| **Parameter**         | **Default value**  | **Description**                                                           |
|:-|:-|-
| **key**               | **set_state**      | Name of the shared attribute on Klyff instance.                     |
...
| **BACnet object id** | **Klyff object id** |
|-|-
