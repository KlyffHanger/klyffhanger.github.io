...
There are 2 ways for upgrade Klyff IoT Gateway, depends on a version that you want (**Release** or **Develop**).
...
To upgrade Klyff IoT Gateway docker installation use **Upgrading** step from [Docker installation guide](/docs/iot-gateway/install/docker-installation/#upgrading).
