...
title: How to enable remote logging feature on Klyff IoT Gateway
description: How to enable remote logging feature on Klyff IoT Gateway
...
This guide will help you to enable remote logging and read logs from Klyff IoT Gateway on your Klyff platform instance.  
...
To do this we use following steps:
  ...
  - As a result now we can monitor the status of the gateway device from Klyff environment.
