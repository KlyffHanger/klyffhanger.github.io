...
google-credentials-for-oauth-1:
    ...
    1:
        ...
        title: 'Enter a OAuth client name, and add the Klyff default redirect URI (if you use Klyff installed locally), which we are going to use in this example, to the "Authorized Redirect URIs" section. Click "Create";'
    2:
...
google-configuration-of-thingsboard-google-1:
    0:
        ...
        title: 'Login to your Klyff instance as System Administrator. Navigate to the "Domains" tab, and click "plus" icon;'
    1:
...
login-with-google-1:
    0:
        ...
        title: 'Navigate to the Klyff login screen. We will see an additional "Login with Google" option. Click this button;'
    1:
    ...
    2:
        ...
        title: 'You are logged into Klyff using your Google email as a Tenant Administrator.'
...
oauth0-configuration-of-thingsboard-1:
    0:
        ...
        title: 'Access your Klyff instance using your System Administrator credentials. Go to the "OAuth 2.0" page of the "Security" section. Navigate to the "OAuth 2.0 clients" tab, and click "plus" icon to add a new client;'
    1:
...
oauth0-configuration-of-thingsboard-3:
    ...
    1:
        ...
        title: 'You have logged into Klyff as a Customer User.'
...
create-new-realm:
    ...
    1:
        ...
        title: 'Enter "Klyff" in the realm name field, and click "Create" button;'
    2:
...
create-client:
    ...
    3:
        ...
        title: 'In the "Login settings" section, add the Klyff default redirect URI to the "Authorized Redirect URIs" section. Then, click "Save";'
    4:
...
endpoint-configuration:
    ...
    1:
        ...
        title: 'A new window with OpenID Endpoint Configuration will open. Check the "Pretty-print" option to make the data view more user-friendly. Here you found "Access token URI," "Authorization URI," "JSON Web Key URI," and "User info URI," which are necessary for configuring the OAuth 2.0 client in Klyff.'
...
keycloak-add-thingsboard-oauth-client:
    0:
        ...
        title: 'Access your Klyff instance using your System Administrator credentials. Navigate to the "OAuth 2.0 clients" tab, and click "plus" icon to add a new client;'
    1:
...
login-with-keycloak-1:
    0:
        ...
        title: 'Go to the Klyff login screen. You will see an additional option, "Login with Keycloak". Click this button;'
    1:
    ...
    2:
        image: /images/user-guide/oauth-2-support/login-with-oauth-1-pe.png
        title: 'You are logged into Klyff using Keycloak authorization credentials.'
