...
assignIntegration:
    ...
    2:
        ...
        title: 'Login to your <b>Klyff Edge</b> instance and open Integrations page'
...
- Klyff PE Edge;
- TCP Integration, running externally and connected to the cloud Klyff Edge instance;
...
An example of sent message and a response from Klyff Edge in the terminal:
