...
assignees:
- stitenko
title: Integration with Klyff
description: Integration guide of TBMQ with Klyff
...
successful-connection-tbmq-to-thingsboard:
    0:
        ...
        title: 'Go to the "Sessions" page in the TBMQ UI. Upon successful establishment of the connection Klyff to TBMQ, we will see a new session and its status - "Connected".'
