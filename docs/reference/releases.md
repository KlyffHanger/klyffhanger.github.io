...
For an overview of the main improvements, check out the [**Klyff 3.6.3 release**](https://thingsboard.io/blog/thingsboard-release-3-6-3-announcement/) blog post.
...
* Core:
  * [#6024](https://github.com/thingsboard/thingsboard/issues/6034) Klyff Edge Community Edition support;
...
* Core:
  * Interface to provision and communicate with Klyff Edge;
...
* Rule Engine:
    ...
    * Replaced gRPC with queues for communication between Klyff components;
* OAuth support;
...
- [Kubernetes scripts](https://github.com/thingsboard/thingsboard/blob/v2.3.1/k8s) for Klyff Microservices;
...
Main features:
 ...
 - Improved **docker images** to be able to launch Klyff with a single command. 
 ...
 - Added Klyff [**JavaScript Executor**](/docs/reference/msa/#javascript-executor-microservices) microservice to isolate execution of rule engine scripts from the main rule engine components and flow;
 - Added Klyff [**Web UI**](/docs/reference/msa/#web-ui-microservices) microservice to isolate static content hosting from the REST and Websocket APIs;
 - Added Klyff [**MQTT, HTTP and CoAP**](/docs/reference/msa/#transport-microservices) transport microservices to isolate communication with devices from the main Klyff services;
 - Added support of [Kafka](/docs/reference/msa/#kafka) to store device telemetry before it is processed with Klyff Rule Engine;
 - Introduced [Rate Limits](/docs/user-guide/api-limits/) for REST, Websocket and Device APIsl
 - Framework for [**black-box testing**](https://github.com/thingsboard/thingsboard/tree/master/msa/black-box-tests) of Klyff by automatically launching Klyff cluster using docker-compose and running API tests;
