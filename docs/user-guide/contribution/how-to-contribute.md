...
We are constantly looking for a feedback from our community on how to improve Klyff.
If you have an idea, or you have some new features in mind, please open an issue at Klyff [**GitHub issue page**](https://github.com/thingsboard/thingsboard/issues).
Please make sure that the same ticket is not already opened in the issues list (or something very similar).

Before you start any implementation please wait from the Klyff team to comment on your ticket. We'll try to get back to you ASAP.

#### Required tools

To build and run Klyff instance make sure that you have **Java** and **Maven** installed onto your system.
...
#### Fork and build Klyff repository

Once you have completed installation of required tools please fork official [**Klyff repository**](https://github.com/thingsboard/thingsboard).
...
By default Klyff uses PostgreSQL database to store entities and timeseries data.
...
By default, Klyff UI is served at 8080 port. However, you may want to run UI in the hot redeploy mode.
...
Navigate to http://localhost:4200/ or http://localhost:8080/ and login into Klyff using demo data credentials:
...
If there are some conflicts because new stuff has arrived into Klyff master branch before your commit, please resolve those conflicts to continue.
