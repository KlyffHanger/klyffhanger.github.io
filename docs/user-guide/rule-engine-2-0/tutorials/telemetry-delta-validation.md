...
Let's assume we have a device that uses a temperature sensor to collect and read temperature readings in the Klyff.
...
Add Device entity in Klyff. Its name is **Thermometer** and its type is **temperature sensor**.
