...
It is expected result. **Controller A** sends RPC call to the Klyff with method **getCurrentTemperature**. 
...
we will see message in the Klyff log file:
...
<br>
<br>
For more details how RPC works in the Klyff, please read [RPC capabilities](/docs/{{docsPrefix}}user-guide/rpc/) Article.
<br>
<br>
