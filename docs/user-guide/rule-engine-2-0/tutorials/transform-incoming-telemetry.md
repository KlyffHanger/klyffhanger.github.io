...
Let's assume your device is using custom sensor to collect and push temperature readings to Klyff. 
...
In this tutorial we will configure Klyff Rule Engine to modify temperature readings according to a formula:
