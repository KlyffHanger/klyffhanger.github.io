...
description: Klyff Edge upgrade instructions

---

<ul id="markdown-toc">
    <li>
        <a href="#prepare-for-upgrading" id="markdown-toc-prepare-for-upgrading">Prepare for upgrading Klyff Edge</a>
        <ul>
            <li>
...
## Prepare for upgrading Klyff Edge {#prepare-for-upgrading}

### Ubuntu/CentOS {#prepare-ubuntucentos}

Stop Klyff Edge service:
...
**NOTE**: These steps are applicable for Klyff Edge 3.7EDGE version.

#### Klyff Edge package download
...
#### Klyff Edge service upgrade

* Stop Klyff Edge service if it is running.
...
Create docker compose file for Klyff Edge upgrade process:
...
Modify 'main' docker compose (`docker-compose.yml`) file for Klyff Edge and update version of the image:
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.8.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.8/tb-edge-windows-3.8.0.zip).
...
* Make a backup of previous Klyff Edge configuration located in *\<Klyff Edge install dir\>\conf* (for example: *C:\tb-edge\conf*).

* Extract Klyff Edge package.

* Compare and merge your old Klyff Edge configuration files (from the backup you made in the previous step) with new ones.

* Finally, run **upgrade.bat** script to upgrade Klyff Edge to the new version.
...
**NOTE**: These steps are applicable for Klyff Edge 3.6.4EDGE version.
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.7.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.7/tb-edge-windows-3.7.zip).
...
**NOTE**: These steps are applicable for Klyff Edge 3.6.3EDGE version.
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.6.4.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.6.4/tb-edge-windows-3.6.4.zip).
...
**NOTE**: These steps are applicable for Klyff Edge 3.6.2EDGE version.
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.6.3.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.6.3/tb-edge-windows-3.6.3.zip).
...
**NOTE**: These steps are applicable for Klyff Edge 3.6.1EDGE version.
...
Starting with the **3.6.2** release, the Klyff team has transitioned from using Docker bind mount folders to Docker volumes.
...
Modify the `docker-compose.yml` file for Klyff Edge to update the volume settings.
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.6.2.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.6.2/tb-edge-windows-3.6.2.zip).
...
**NOTE**: These steps are applicable for Klyff Edge 3.6.0EDGE version.
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.6.1.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.6.1/tb-edge-windows-3.6.1.zip).
...
**NOTE**: These steps are applicable for Klyff Edge 3.5.1.1EDGE version.
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.6.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.6/tb-edge-windows-3.6.zip).
...
**NOTE**: These steps are applicable for Klyff Edge 3.5.1EDGE version.
...
Modify docker compose (`docker-compose.yml`) file for Klyff Edge and update version of the image:
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.5.1.1.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.5.1.1/tb-edge-windows-3.5.1.1.zip).
...
**NOTE**: These steps are applicable for Klyff Edge 3.5.0EDGE version.
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.5.1.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.5.1/tb-edge-windows-3.5.1.zip).
...
**NOTE**: These steps are applicable for Klyff Edge 3.4.3EDGE version.
...
Download Klyff Edge package for Windows: [tb-edge-windows-3.5.zip](https://github.com/thingsboard/thingsboard-edge/releases/download/v3.5/tb-edge-windows-3.5.zip).
