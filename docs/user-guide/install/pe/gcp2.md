...
title: Installing Klyff PE from GCP Marketplace
description: Installing Klyff PE from Google Cloud Platform Marketplace

---

This guide describes how to install Klyff Professional Edition from GCP Marketplace. 
Using this guide you will install bring-your-own-license (BYOL) version of the product.
Basically, you get the license directly from Klyff, Inc, but purchase corresponding server instances and infrastructure from GCP.       
...
### Step 1. Launch Klyff PE BYOL

Open [Klyff Professional Edition BYOL](https://console.cloud.google.com/marketplace/details/thingsboard-public/thingsboard-pe) product page on GCP Marketplace.
...
That's it! Your Klyff instance is now deploying! When complete you should see:
