---
layout: docwithnav
title: Connect Klyff to Datastax Astra DB 
description: Connect Klyff to Datastax Astra DB
hidetoc: "true"
---

This guide describes how to setup Datastax Astra DB cloud for your Klyff. This is an alternative having your own Cassandra cluster.
...
### Step 5. Set connection parameters on Klyff

Here the environments you need to set to use your Astra DB with Klyff.

#### Klyff service

For Klyff as a local service add to the `/etc/thingsboard/conf/thingsboard.conf`
...
### Step 6. Run standard Klyff install

Klyff is already support install on Astra DB cloud.
