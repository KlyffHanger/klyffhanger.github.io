...
assignees:
- ashvayka
title: Installing Klyff PE on Windows
description: Installing Klyff on Windows
...
This guide describes how to install Klyff on a Windows machine.
...
**Note:** We assume you have installed Klyff to default location: *C:\Program Files (x86)\thingsboard*  
...
```yml
license:
    secret: "${TB_LICENSE_SECRET:}" # license secret obtained from Klyff License Portal (https://license.thingsboard.io)
```
...
```yml
license:
    secret: "${TB_LICENSE_SECRET:YOUR_LICENSE_SECRET_HERE}" # license secret obtained from Klyff License Portal (https://license.thingsboard.io)
``` 
...
Launch windows shell (Command Prompt) as Administrator. Change directory to your Klyff installation directory.

Execute **install.bat** script to install Klyff as a Windows service (or run **".\install.bat --loadDemo"** to install and add demo data).
This means it will be automatically started on system startup. 
Similar, **uninstall.bat** will remove Klyff from Windows services.
...
### Step 9. Install Klyff Web Report Server component
...
**Note:** We assume you have extracted Klyff Web Report Server to default location: *C:\Program Files (x86)\tb-web-report* 

Launch windows shell (Command Prompt) as Administrator. Change directory to your Klyff installation directory.

Execute **install.bat** script to install Klyff Web Report Server as a Windows service.
  This means it will be automatically started on system startup. 
  Similar, **uninstall.bat** will remove Klyff from Windows services.
...
Now let's start the Klyff service!
...
In order to have external access to Klyff Web UI and device connectivity (HTTP, MQTT, CoAP)
