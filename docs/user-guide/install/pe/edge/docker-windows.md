...
title: Installing Klyff Edge using Docker (Windows)
description: Installing Klyff Edge using Docker (Windows)
---
...
This guide will help you to install and start Klyff Edge using Docker on Windows. 
...
Windows users should use docker managed volume for Klyff Edge DataBase. 
