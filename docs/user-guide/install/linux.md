...
assignees:
- ashvayka
title: Installing Klyff on Linux
description: Installing Klyff on Linux
...
This guide describes how to install Klyff on a Linux based server machine.
...
To run Klyff and third-party components on a single machine you will need at least 1Gb of RAM.

### Third-party components installation

#### Java

Klyff service is running on Java 11. 
...
### Configure Klyff to use the external database
...
```bash
# Update Klyff memory usage and restrict it to 256MB in /etc/thingsboard/conf/thingsboard.conf
...
Klyff logs are stored in the following directory:
