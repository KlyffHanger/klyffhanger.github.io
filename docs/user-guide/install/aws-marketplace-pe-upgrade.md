---
layout: docwithnav
title: Upgrading Klyff PE from AWS Marketplace
description: Upgrading Klyff PE from AWS Marketplace

---

This guide describes how to upgrade Klyff Professional Edition from AWS Marketplace. 

<ul id="markdown-toc">
  <li>
    <a href="#upgrading-to-thingsboard-pe-v202" id="markdown-toc-upgrading-to-thingsboard-pe-v202">Upgrading to Klyff PE v.2.0.2</a>
  </li>
  <li>
    <a href="#upgrading-to-thingsboard-pe-v210" id="markdown-toc-upgrading-to-thingsboard-pe-v210">Upgrading to Klyff PE v.2.1.0</a>
  </li>
  <li>
    <a href="#upgrading-to-thingsboard-pe-v213" id="markdown-toc-upgrading-to-thingsboard-pe-v213">Upgrading to Klyff PE v.2.1.3</a>
  </li>
  <li>
    <a href="#upgrading-to-thingsboard-pe-v220" id="markdown-toc-upgrading-to-thingsboard-pe-v220">Upgrading to Klyff PE v.2.2.0</a>
  </li>
  <li>
    <a href="#upgrading-to-thingsboard-pe-v221" id="markdown-toc-upgrading-to-thingsboard-pe-v221">Upgrading to Klyff PE v.2.2.1</a>
  </li>
  <li>
    <a href="#upgrading-to-thingsboard-pe-v230" id="markdown-toc-upgrading-to-thingsboard-pe-v230">Upgrading to Klyff PE v.2.3.0</a>
  </li>
  <li>
    <a href="#upgrading-to-thingsboard-pe-v231" id="markdown-toc-upgrading-to-thingsboard-pe-v231">Upgrading to Klyff PE v.2.3.1</a>
  </li>
</ul>

## Upgrading to Klyff PE v.2.0.2

These steps are applicable for Klyff PE with Cassandra v.1.4.

{% include templates/upgrade-to-20-notice.md %}

#### Connect to your Klyff PE v.1.4 instance over SSH.
...
```text
Updating Klyff Professional Edition...
Installing Klyff PE package...
...
```text
 ===================================================
 :: Klyff Professional Edition ::       (v2.0.2PE)
 ===================================================

Starting Klyff Upgrade from version 1.4.0 ...
Upgrading Klyff from version 1.4.0 to 2.0.0 ...
Updating schema ...
Schema updated.
Updating data from version 1.4.0 to 2.0.0 ...
Updating system data...
Upgrading Klyff from version 2.0.0 to 2.0.0PE ...
Updating schema ...
Schema updated.
Updating converters ...
Converters updated.
...
## Upgrading to Klyff PE v.2.1.0

These steps are applicable for Klyff PE with Cassandra v.2.0.2.

#### Connect to your Klyff PE v.2.0.2 instance over SSH.
...
or goto EC2 instances and locate your Klyff PE v2.0.2 instance. 
Then select **Actions -> Connect** and follow instructions provided in **Connect To Your Instance** dialog.
...
```text
 ===================================================
 :: Klyff Professional Edition ::       (v2.1.0PE)
 ===================================================

Starting Klyff Upgrade from version 2.0.0 ...
Upgrading Klyff from version 2.0.0 to 2.1.0PE ...
Updating schema ...
Schema updated.
Updating converters ...
Converters updated.
...
#### Install Klyff Web Report Server
...
Download Klyff Web Report Server installation script:
...
```text
Installing Klyff Web Report Server...
Installing Klyff Web Report Server package...
...
Latest version of Klyff Web Report Server has been installed.
```

#### Start Klyff Web Report Server

Execute the following command in order to start Klyff Web Report Server:

```bash
$ sudo service tb-web-report start
```

## Upgrading to Klyff PE v.2.1.3

These steps are applicable for Klyff PE with Cassandra v.2.1.0.

#### Connect to your Klyff PE v.2.1.0 instance over SSH.
...
or goto EC2 instances and locate your Klyff PE v2.1.0 instance. 
Then select **Actions -> Connect** and follow instructions provided in **Connect To Your Instance** dialog.
...
```text
 ===================================================
 :: Klyff Professional Edition ::       (v2.1.3PE)
 ===================================================

Starting Klyff Upgrade from version 2.0.0 ...
Upgrading Klyff from version 2.0.0 to 2.1.1 ...
Updating schema ...
Schema updated.
Upgrading Klyff from version 2.1.1 to 2.1.2 ...
...
Upgrading Klyff from version 2.1.2 to 2.1.3PE ...
Updating schema ...
Schema updated.
Updating converters ...
Converters updated.
...
## Upgrading to Klyff PE v.2.2.0

These steps are applicable for Klyff PE with Cassandra v.2.1.3.

#### Connect to your Klyff PE v.2.1.3 instance over SSH.
...
or goto EC2 instances and locate your Klyff PE v2.1.3 instance. 
Then select **Actions -> Connect** and follow instructions provided in **Connect To Your Instance** dialog.
...
```text
 ===================================================
 :: Klyff Professional Edition ::       (v2.2.0PE)
 ===================================================
...
Restoring entity views ...
Entity views restored.
Upgrading Klyff from version 2.1.3 to 2.2.0 ...
Upgrading Klyff from version 2.2.0 to 2.2.0PE ...
Updating schema ...
Schema updated.
Updating converters ...
Converters updated.
...
#### Upgrade Klyff Web Report Server to v.2.2.0
...
## Upgrading to Klyff PE v.2.2.1

These steps are applicable for Klyff PE with Cassandra v.2.2.0.

#### Connect to your Klyff PE v.2.2.0 instance over SSH.
...
or goto EC2 instances and locate your Klyff PE v2.2.0 instance. 
Then select **Actions -> Connect** and follow instructions provided in **Connect To Your Instance** dialog.
...
## Upgrading to Klyff PE v.2.3.0

These steps are applicable for the following Klyff PE versions:

- Klyff Professional Edition with Cassandra v.2.2.0PE
- Klyff PE Maker v.2.2.1PEMK
- Klyff PE Prototype v.2.2.1PEPT
- Klyff PE Startup v.2.2.1PEST
- Klyff PE Business v.2.2.1PEBS
- Klyff PE Enterprise v.2.2.1PE

#### Connect to your Klyff PE instance over SSH.
...
or goto EC2 instances and locate your Klyff PE instance. 
Then select **Actions -> Connect** and follow instructions provided in **Connect To Your Instance** dialog.
...
For **Klyff Professional Edition with Cassandra** or **Klyff PE Enterprise**: ```-Dplatform=ami-pe-cassandra```

For  **Klyff PE Maker**: ```-Dplatform=ami-pe-mk```

For  **Klyff PE Prototype**: ```-Dplatform=ami-pe-pt```

For  **Klyff PE Startup**: ```-Dplatform=ami-pe-st```

For  **Klyff PE Business**: ```-Dplatform=ami-pe-bs```

The final line should be like this (example for **Klyff Professional Edition with Cassandra**):
...
For **Klyff PE Maker**, **Klyff PE Prototype** or **Klyff PE Startup**:

{% include templates/disable-hsqldb.md %}  

{% include templates/enable-postgresql.md %} 

For **Klyff Professional Edition with Cassandra**, **Klyff PE Business** or **Klyff PE Enterprise**:
...
```text
 ===================================================
 :: Klyff Professional Edition ::       (v2.3.0PE)
 ===================================================

Starting Klyff Upgrade from version 2.2.0 ...
Upgrading Klyff from version 2.2.0 to 2.3.0PE ...
Updating schema ...
Schema updated.
Updating converters ...
Converters updated.
...
## Upgrading to Klyff PE v.2.3.1

These steps are applicable for the following Klyff PE versions:

- Klyff Professional Edition with Cassandra v.2.2.0PE
- Klyff PE Maker v.2.3.0PEMK
- Klyff PE Prototype v.2.3.0PEPT
- Klyff PE Startup v.2.3.0PEST
- Klyff PE Business v.2.3.0PEBS
- Klyff PE Enterprise v.2.3.0PE
...
```text
 ===================================================
 :: Klyff Professional Edition ::       (v2.3.1PE)
 ===================================================

Starting Klyff Upgrade from version 2.3.0 ...
Upgrading Klyff from version 2.3.0 to 2.3.1 ...
Upgrading Klyff from version 2.3.1 to 2.3.1PE ...
Updating schema ...
Schema updated.
Updating converters ...
Converters updated.
...
#### Upgrade Klyff Web Report Server to v.2.3.1
