...
description: Klyff IoT platform cluster setup with Kubernetes and Minikube guide
...
This guide will help you to setup Klyff in cluster mode using Minikube tool. 
