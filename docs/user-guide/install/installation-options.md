...
assignees:
- ashvayka
title: Klyff installation options
description: Klyff installation instructions for various operation systems and cloud platforms
notitle: "true"
---
       ...
       <div class="install-options-hero">
          <div class="container">
            <div class="install-options-hero-content">
                <h1>Klyff installation options</h1>
                <div class="install-options-description">
                    <p>
                        Klyff is designed to run and utilize on majority of hardware, from local Raspberry PI to powerful servers in the cloud
                    </p>
                </div>
            </div>
