---
layout: docwithnav
title: Upgrading HAProxy Load Balancer for Klyff PE from AWS Marketplace
description: Upgrading HAProxy Load Balancer for Klyff PE from AWS Marketplace
hidetoc: "true"
---

This guide describes how to remove dockerized version of HAProxy Load Balancer and install HAProxy with Let's Encrypt
as ubuntu service for Klyff Professional Edition from AWS Marketplace.

* TOC
{:toc}

#### Connect to your Klyff PE AWS instance over SSH
