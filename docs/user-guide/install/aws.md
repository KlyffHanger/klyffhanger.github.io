...
notitle: "true"
description: Klyff IoT platform  AWS cluster setup guide
       ...
       <div class="install-options-hero">
          <div class="container">
            <div class="install-options-hero-content">
                <h1>Klyff Setup options on AWS</h1>
                                ...
                                <div class="deployment-cards-container">
                                   ...
                                   <div class="deployment-card-block">
                                       <a href="/docs/user-guide/install/cluster/aws-eks-setup/">
                                           <span>
                                               <div class="deployment-logo">
                                                   <img width="" src="/images/install/cloud/eks.svg" title="Klyff setup with Kubernetes on AWS EKS" alt="AWS EKS">
                                                </div>
                                           </span>
                                       </a>
                                   </div>
