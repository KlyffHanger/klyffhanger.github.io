...
assignees:
- ashvayka
title: Klyff Cloud Subscription plans definition
...
Klyff web interface allows you to configure your company or product logo and color scheme in 2 minutes with zero coding efforts and no service restart required. 
See feature [documentation](/docs/{{docsPrefix}}user-guide/white-labeling/) for more details. Klyff Cloud extends white-labeling feature with ability to configure own domain name easily. 
See [managing domain](/docs/{{docsPrefix}}domains/) for more details. 
