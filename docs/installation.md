          ...
          <div class="container">
            ...
            <div class="cards">
                ...
                <a href="/docs/user-guide/install/pe/installation-options/" class="card thingsboard-pe">
                    <div class="card-title">
                        <span class="title-text">Klyff<br>Professional Edition</span>
                    </div>
