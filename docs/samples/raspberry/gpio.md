---
layout: docwithnav
title: Raspberry Pi GPIO control over MQTT using Klyff
description: Klyff IoT Platform sample for Raspberry Pi GPIO control over MQTT
...
This sample application will allow you to control GPIO of your Raspberry Pi device using Klyff web UI. We will observe GPIO control using Led connected to one of the pins.
The purpose of this application is to demonstrate Klyff [RPC capabilities](/docs/user-guide/rpc/).

Raspberry Pi will use simple application written in Python that will connect to Klyff server via [MQTT](https://en.wikipedia.org/wiki/MQTT) and listen to RPC commands.
