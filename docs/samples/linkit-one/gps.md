---
layout: docwithnav
title: GPS data upload and visualization using LinkIt ONE and Klyff
description: Klyff IoT Platform sample for GPS data upload and visualization using LinkIt ONE
...
Collected data is pushed to Klyff for storage and visualization.
The purpose of this application is to demonstrate Klyff data collection API and visualization capabilities.

The GPS module is a built-in module of [LinkIt ONE](https://wiki.seeedstudio.com/LinkIt_ONE/). 
LinkIt ONE pushes data to Klyff server via MQTT protocol by using [PubSubClient](https://github.com/knolleary/pubsubclient) library for Arduino.
...
**Note** You need to edit following constants and variables in the sketch:
 ...
 - thingsboardServer - Klyff HOST/IP address that is accessible within your wifi network. Specify "demo.thingsboard.io" if you are using [live demo](https://demo.thingsboard.io/) server.
...
After application will be uploaded and started it will try to connect to Klyff node using mqtt client and upload "latitude" and "longitude" attributes once per second.
