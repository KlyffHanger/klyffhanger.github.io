...
#define TOKEN               "TOKEN"
// Klyff server instance.
#define THINGSBOARD_SERVER  "demo.thingsboard.io"

// Baud rate for debug serial
#define SERIAL_DEBUG_BAUD    115200

// Initialize Klyff client
...
// Array with LEDs that should be controlled from Klyff, one by one
...
void loop() {
  ...
  if (send_passed > send_delay) {
    ...
    // Uploads new telemetry to Klyff using MQTT. 
