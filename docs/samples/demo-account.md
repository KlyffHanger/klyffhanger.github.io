...
- ashvayka
title: Demo Account
description: Klyff default demo accounts
...
Klyff installation contains single tenant account that is used in sample applications and contains a lot of pre-provisioned entities for demonstration purposes.
